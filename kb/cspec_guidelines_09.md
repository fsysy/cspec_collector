...
Document: ClinGen Epilepsy Sodium Channel Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for SCN8A Version 2.0
CSpec ID: GN070
...
Fetched: 2026-08-05T00:33:00.704353+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN070
...
Document: ClinGen Limb Girdle Muscular Dystrophy Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for SGCA Version 2.0
CSpec ID: GN189
...
Fetched: 2026-08-05T00:34:42.652203+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN189
...
Use the PP4 table (see supplementary file “PP4 table SGCA”) to determine the appropriate PP4 strength level. Apply PP4 only once, for a patient meeting the highest possible strength level. When applied together, PP1 and PP4 cannot exceed 5 Bayesian pts (Supporting + Strong or Moderate + Moderate).
...
While case-control studies could potentially be considered for a few pathogenic variants with high minor allele frequency, the VCEP is unaware of any such studies being conducted for _SGCA_. Any case-control study would require careful selection of an appropriate control population given the potential for late onset and mild disease.
...
Please see attached _SGCA_ PVS1 flowchart. In addition, for any variant with RNA/splicing data, follow the SVI Working Group’s recommendations (Walker et al. 2023; PMID: 37352859). See supplementary file “experimental splice data”.
...
Document: ClinGen Limb Girdle Muscular Dystrophy Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for SGCB Version 2.0
CSpec ID: GN184
VCEP: Limb Girdle Muscular Dystrophy Variant Curation Expert Panel
Version: 2.0
Status: current_released
Diseases: MONDO:0015152
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0000007
Fetched: 2026-08-05T00:34:38.093119+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN184
...
Use the PP4 table (see supplementary file “PP4 table SGCB”) to determine the appropriate PP4 strength level. Apply PP4 only once, for a patient meeting the highest possible strength level. When applied together, PP1 and PP4 cannot exceed 5 Bayesian pts (Supporting + Strong or Moderate + Moderate).
...
PS3\_Moderate may be applicable for sarcoglycan complex membrane localization assays that have been clinically validated with ≥11 control variants that meet criteria specified in Brnich et al. 2020 (PMID: 31892348) for the number of pathogenic and benign control variants. 

*   Sarcoglycan complex cell surface localization functional score \<-0.5 in Li et al. 2023 (PMID: 37317968). See supplementary file “PS3 assays\_SGCB”.
...
Use without disease-specific modification if case-control studies are available.   
While case-control studies could potentially be considered for a few pathogenic variants with high minor allele frequency, the VCEP is unaware of any such studies being conducted for _SGCB_. Any case-control study would require careful selection of an appropriate control population given the potential for late onset and mild disease.
...
Please see attached _SGCB_ PVS1 flowchart. In addition, for any variant with RNA/splicing data, follow the SVI Working Group’s recommendations (Walker et al. 2023; PMID: 37352859). See supplementary file “experimental splice data”.
...
Document: ClinGen Limb Girdle Muscular Dystrophy Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for SGCD Version 2.0
CSpec ID: GN186
VCEP: Limb Girdle Muscular Dystrophy Variant Curation Expert Panel
Version: 2.0
Status: current_released
Diseases: MONDO:0015152
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0000007
Fetched: 2026-08-05T00:34:39.914929+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN186
...
Use the PP4 table (see supplementary file “PP4 table SGCD”) to determine the appropriate PP4 strength level. Apply PP4 only once, for a patient meeting the highest possible strength level. When applied together, PP1 and PP4 cannot exceed 5 Bayesian pts (Supporting + Strong or Moderate + Moderate).
...
Use without disease-specific modification if case-control studies are available.   
While case-control studies could potentially be considered for a few pathogenic variants with high minor allele frequency, the VCEP is unaware of any such studies being conducted for _SGCD_. Any case-control study would require careful selection of an appropriate control population given the potential for late onset and mild disease.
...
Please see attached _SGCD_ PVS1 flowchart. In addition, for any variant with RNA/splicing data, follow the SVI Working Group’s recommendations (Walker et al. 2023; PMID: 37352859). See supplementary file “experimental splice data”.
...
Document: ClinGen Limb Girdle Muscular Dystrophy Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for SGCG Version 2.0
CSpec ID: GN185
VCEP: Limb Girdle Muscular Dystrophy Variant Curation Expert Panel
Version: 2.0
Status: current_released
Diseases: MONDO:0015152
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0000007
Fetched: 2026-08-05T00:34:39.006087+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN185
...
Use the PP4 table (see supplementary file “PP4 table SGCG”) to determine the appropriate PP4 strength level. Apply PP4 only once, for a patient meeting the highest possible strength level. When applied together, PP1 and PP4 cannot exceed 5 Bayesian pts (Supporting + Strong or Moderate + Moderate).
...
Use without disease-specific modification if case-control studies are available.   
While case-control studies could potentially be considered for a few pathogenic variants with high minor allele frequency, the VCEP is unaware of any such studies being conducted for _SGCG_. Any case-control study would require careful selection of an appropriate control population given the potential for late onset and mild disease.
...
Please see attached _SGCG_ PVS1 flowchart. In addition, for any variant with RNA/splicing data, follow the SVI Working Group’s recommendations (Walker et al. 2023; PMID: 37352859). See supplementary file “experimental splice data”.
...
Document: ClinGen Cerebral Creatine Deficiency Syndromes Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for SLC6A8 Version 2.1
CSpec ID: GN027
VCEP: Cerebral Creatine Deficiency Syndromes Variant Curation Expert Panel
Version: 2.1
Status: current_released
Diseases: MONDO:0010305
Modes of inheritance: 
Fetched: 2026-08-05T00:32:25.311976+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN027
...
*   REVEL score ≤ 0.20
*   For variants potentially impacting splicing, Splice AI score \<0.10
...
*   SpliceAI score ≤0.10
*   May also be applied in conjunction with PB4 for an intronic variant outside the splice region (beyond -4bp or +7 bp)
...
*   BS1 and BS2 should not be co-applied based on the number of homo- or hemizygotes present in gnomAD
...
*   Creatine transport assay demonstrating ≥50% normal transport activity compared to controls when using ≤125uM creatine.  Any study using >125uM creatine for creatine transporter assays cannot be used as Benign evidence.
*   RT-PCR evidence demonstrating no observable effect of splicing for canonical splice, splice region, and deep intronic variants
*   Expression assay demonstrating wildtype transcript levels
...
*   Same as described.
*   Splice AI score must be \<0.1 for both the variant under review and the previously reported variant to apply this code.
...
*   Applicable for missense variants with REVEL >0.75
*   Applicable for canonical splice, splice region, or deep intronic variants with SpliceAI delta score ≥0.20
...
See attached PP4 table for phenotypes in males and/or female probands required to meet PP4 criteria. Point total for applicable PP4 criteria should be summed.

**PP4\_Moderate (+2):** = 3 points
...
**PP4\_Strong (+4):** = 4 points  

*   Two or more data types are required to reach strong. 
*   An individual used to assign PP4, at any weight, cannot be also included for PS4 count. If multiple  unrelated probands with the variant have been identified, it is recommended that the case with the  highest PP4 points is assigned the appropriate weight for PP4, and the other cases are used for PS4.
*   Variant must meet PM2\_Supporting for PP4 to apply at any strength. 
*   For PP4 to be applied at strong, full _SLC6A8_ gene sequencing, including all coding exons and intron/exon boundaries must have been carried out. If not, downgrade by one strength level.
*   Total locus evidence for PP1+PP4 must be capped at 5.0 points per allele
...
*   PS1\_Moderate may also be applicable for intronic variants in the canonical splice consensus sequence or in the splice region.  See “PS1\_SpliceVariants” for applicable points
...
*   PS1 may also be applicable for intronic variants in the canonical splice consensus sequence or in the splice region.  See “PS1\_SpliceVariants” for applicable points, from Walker, [et.al](http://et.al). PMID:37352859
*   Splice AI score must be \<0.1 for both the variant under review and the previously reported variant to apply this code.
...
*   PS1 is applicable as described
*   PS1\_Supp may also be applicable for intronic variants in the canonical splice consensus sequence or in the splice region.  See “PS1\_SpliceVariants” for applicable points
...
*   Identified in male proband minimally meeting PP4\_Supporting if the biological mother (asymptomatic or affected) has a de novo SLC6A8 variant confirmed by parental testing in her parents
*   Identified in male proband minimally meeting PP4\_Supporting if the biological mother (asymptomatic or affected) has a mosaic SLC6A8 (≤30% variant allele frequency)
...
Is applicable in the case of a hemizygous male or a heterozygous female minimally meeting PP4\_Supporting with a de novo variant

*   confirmation of maternity only is sufficient in male probands
*   confirmation of both maternity and paternity is necessary in female probands
...
Creatine transport deficient mouse models have biochemical findings including reduced/absent creatine in brain \[PMID:21249153, 25485098, 33389772\], which has been recapitulated in brain-specific creatine transport knockout models \[PMID:22751104\].  PS3\_Moderate is applicable when the variant under review is used to generate a mouse knock-in model and assessment of brain creatine demonstrates significantly reduced or absent brain creatine when compared to wildtype littermates.
...
Creatine transport assay using site directed mutagenesis to introduce the variant under review into _SLC6A8_ deficient cell line, and results in \<10% creatine transport compared to wildtype cells when using ≤125uM creatine, or ≤25% when using creatine >125uM.
...
*   2 independent probands with elevated urine creatine/creatinine ratio on one  occasion at minimum, in addition to any proband used for PP4. 
*   Affected females may be counted if meeting PP4\_Supporting
...
*   4 independent probands with elevated urine creatine/creatinine ratio on one  occasion at minimum, in addition to any proband used for PP4. 
*   Affected females may be counted if meeting PP4\_Supporting
*   Variant must meet PM2\_Supporting criterion for PS4 to apply.
...
*   1 independent proband with elevated urine creatine/creatinine ratio on one  occasion at minimum, in addition to any proband used for PP4. 
*   Variant must meet PM2\_Supporting criterion for PS4 to apply.
...
*   8 independent probands with elevated urine creatine/creatinine ratio on one  occasion at minimum, in addition to any proband used for PP4. 
*   Affected females may be counted if meeting PP4\_Supporting
*   Variant must meet PM2\_Supporting criterion for PS4 to apply.
...
Document: ClinGen Cardiomyopathy Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for TNNI3 Version 1.0
CSpec ID: GN098
...
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0000006
Fetched: 2026-08-05T00:33:25.226985+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN098
...
Allele frequency is **≥0.0001 for** _**TNNI3**_ based on the **filtering allele frequency (FAF)** in **gnomAD** in the subpopulation with the highest frequency (popmax).
...
Applicable to missense variants in _TNNI3_ in the specific regions listed below (Walsh _et al._ 2019[<sup>10</sup>](#pmid_30696458)). 
...
7.  Consider the size of the case cohort — larger cohorts are likely to provide more accurate estimates of variant frequency; therefore, it may be preferable to use data from the largest available case series for case-control analyses (e.g., Walsh _et al._ 2017[<sup>5</sup>](#pmid_27532257), [DECIPHER](https://www.deciphergenomics.org/gene/TNNI3/patient-overlap/snvs)).
...
Document: ClinGen Cardiomyopathy Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for TNNT2 Version 1.0
CSpec ID: GN099
VCEP: Cardiomyopathy Variant Curation Expert Panel
Version: 1.0
Status: current_released
Diseases: MONDO:0005045; MONDO:0005021
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0000006
Fetched: 2026-08-05T00:33:26.150400+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN099
...
Allele frequency is **≥0.0001 for** _**TNNT2**_ based on the **filtering allele frequency (FAF)** in **gnomAD** in the subpopulation with the highest frequency (popmax).
...
Applicable to missense variants in _TNNT2_ in the specific regions listed below (Walsh _et al._ 2019[<sup>10</sup>](#pmid_30696458)). 
...
5.  The cohorts do not overlap with other cohorts being used in the analysis (i.e., cases are not being counted more than once).
6.  The population diversity of the case and control cohorts are broadly similar.
7.  Consider the size of the case cohort — larger cohorts are likely to provide more accurate estimates of variant frequency; therefore, it may be preferable to use data from the largest available case series for case-control analyses (e.g., Walsh _et al._ 2017[<sup>5</sup>](#pmid_27532257), [DECIPHER](https://www.deciphergenomics.org/gene/TNNT2/patient-overlap/snvs)).
...
Document: ClinGen TP53 Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for TP53 Version 2.4
CSpec ID: GN009
VCEP: TP53 Variant Curation Expert Panel
Version: 2.4
Status: current_released
Diseases: MONDO:0018875
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0000006
Fetched: 2026-08-05T00:32:09.381457+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN009
...
**Missense variants** _(See flowchart for application of PP3 and BP4 rules for missense variants):_
...
A (synonymous) silent or intronic variant for which RNA splicing assay data demonstrates no splicing aberration, as per recommendations from Walker et al., 2023 (PMID: 37352859).
...
Functional on Kato et al. data **AND** no loss of function (LOF) by the majority of available eligible assays
...
Partially functional on Kato et al. data **AND** no evidence of loss of function (LOF) by **all** available assays
...
Missense variants within the following codons using transcript NM\_00546.4: 175, 245, 248, 249, 273, 282. This code weight can also be used for germline missense variants seen in cancerhotspots.org with ≥ 10 somatic occurrences for the same amino acid change.
...
This rule should be applied at supporting level. Variant should have an allele frequency of less than 0.00003 (0.003%) in gnomAD or another large sequenced population. If multiple alleles are present within any genetic ancestry group, allele frequency in that group must be \<0.00004 (0.004%). Genetic ancestry groups influenced by founder effects (such as Ashkenazi Jewish, Finnish, Amish, Middle Eastern, and “Remaining”) should be ignored. 
...
Missense variant at an amino acid residue where 1 different missense variant previously determined to be pathogenic according to the _TP53_ VCEP’s specifications has been seen before.
...
Missense variant at an amino acid residue where ≥2 different missense variants previously determined to be pathogenic according to the _TP53_ VCEP’s specifications have been seen before.
...
Observation of the variant with VAF 5-35% (i.e., once or multiple times with VAF >25-35% and/or once with VAF 5-25%)
...
Can be applied to variants asserted as Likely Pathogenic following the _TP53_ VCEP’s specifications.
...
Can be applied to variants asserted as Pathogenic following the _TP53_ VCEP’s specifications.
...
Partially functional on Kato et al. data **AND** loss of function (LOF) by the majority of other available assays
...
Non-functional on Kato et al. data **AND** loss of function (LOF) by the majority of other eligible assays
...
Non-functional on Kato et al. data **AND** abnormal on Kawaguchi et al. data regardless of other assays
