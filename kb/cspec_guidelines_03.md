...
Document: ClinGen Limb Girdle Muscular Dystrophy Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for DYSF Version 2.0
CSpec ID: GN180
...
Fetched: 2026-08-05T00:34:34.842545+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN180
...
Use the PP4 table (see supplementary file “PP4 table DYSF”) to determine the appropriate PP4 strength level. Apply PP4 only once, for a patient meeting the highest possible strength level. When applied together, PP1 and PP4 cannot exceed 5 Bayesian pts (Supporting + Strong or Moderate + Moderate).
...
PS3\_Moderate may also be applied for dysferlin membrane localization assays that have been clinically validated with ≥11 control variants that meet criteria specified in Brnich et al. 2020 (PMID: 31892348) for the number of pathogenic and benign control variants. 

*   Dysferlin membrane localization functional score \<0.25 AND concordant immunocytochemistry assay result in Tominaga et al. 2022 (concordant readout of “non-functional” for both assays) (PMID: 35028538). See supplementary file “PS3 assays\_DYSF”.
...
While case-control studies could potentially be considered for a few pathogenic variants with high minor allele frequency, the VCEP is unaware of any such studies being conducted for _DYSF_. Any case-control study would require careful selection of an appropriate control population given the potential for late onset and mild disease.
...
Please see attached _DYSF_ PVS1 flowchart. In addition, for any variant with RNA/splicing data, follow the SVI Working Group’s recommendations (Walker et al. 2023; PMID: 37352859). See supplementary file “experimental splice data”.
...
Document: ClinGen Hereditary Hemorrhagic Telangiectasia Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for ENG Version 1.1
CSpec ID: GN136
VCEP: Hereditary Hemorrhagic Telangiectasia Variant Curation Expert Panel
Version: 1.1
Status: current_released
Diseases: MONDO:0008535
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0000006
Fetched: 2026-08-05T00:33:57.398918+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN136
...
Apply if a likely pathogenic or pathogenic variant (based on HHT VCEP rules) is found in _ACVRL1_.
...
Fetched: 2026-08-05T00:32:14.078745+00:00
...
Document: ClinGen Coagulation Factor Deficiency Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for F8 Version 2.0
CSpec ID: GN071
VCEP: Coagulation Factor Deficiency Variant Curation Expert Panel
Version: 2.0
Status: current_released
Diseases: MONDO:0010602
Modes of inheritance: 
Fetched: 2026-08-05T00:33:01.450927+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN071
...
MAF cutoff of greater or equal to 0.0333% (or 0.000333).
...
This code can be applied for variants reaching a REVEL score of 0.3 or below AND a Splice AI score of less than or equal to 0.1.
...
Applicable for variants that have no observable splicing impact with RNA sequencing and/or minigene assay and a SpliceAI score of less than or equal to 0.1.
...
Splice AI should be used to suggest no splicing impact. Splicing prediction score of less than or equal to 0.1 is required. Conservation should be assess using PhyloP (cutoff less than 0.1) and PhastCons (cutoff less than 0.5).
...
MAF cutoff of greater than or equal to 0.00333% (or 0.0000333).
...
This evidence code can be used when a _F8_ variant is observed in a male with a normal factor VIII activity level (at least >40% IU or as defined by laboratory cut off) using a one stage and/or a chromogenic assay.
...
This code can be used for _F8_ gene variants studied in a cell line or mouse model setting that confer a normal factor VIII activity level AND normal factor VIII antigen level OR normal Western Blot.
...
This code can be used for _F8_ gene variants studied in a cell line or mouse model setting that confer the following results:                    
...
This evidence code can be used when a _F8_ variant is observed in a male with a family history of hemophilia A and has a normal factor VIII activity level.
...
This code can be applied at the moderate level for variants involving the following residues: 
...
This code can be applied at the strong level for variants involving the following residues: R391-S392, R759-S760, E1701-Q1705, R1708-S1709, Y1683, Y1689, Y737, Y742.
...
This evidence code can be applied when there is 1 pathogenic variant or 2 likely pathogenic variants at the same residue based on the _F8_ rule specifications from the Coagulation Factor Deficiency VCEP and where _in silico_ predictors do not suggest a splicing defect.
...
This evidence code can be applied when there is 1 likely pathogenic variant at the same residue based on the _F8_ rule specifications from the Coagulation Factor Deficiency VCEP and where _in silico_ predictors do not suggest a splicing defect.
...
The code is application when there are at least 3 meioses across one or more families.
...
The code is application when there are ≥4 meioses across ≥2 families.
...
The code is application when there are 2 meioses in one family **OR** 1 meiosis between 2 affected siblings.
...
Code can be applied for variants where the REVEL score is greater than or equal to 0.6 or a SpliceAI score of greater than or equal to 0.2.
...
Proband must meet hemophilia A phenotype criteria AND have full gene sequencing and deletion/duplication analysis.
...
This evidence code can be applied when there is 1 likely pathogenic variants at the same residue based on _F8_ gene rule specifications from the Coagulation Factor Deficiency VCEP and where _in silico_ predictors do not suggesting a splicing defect.
...
This evidence code can be applied when there is 1 pathogenic variant or 2 likely pathogenic variants at the same residue based on _F8_ gene rule specifications from the Coagulation Factor Deficiency VCEP and where _in silico_ predictors do not suggest a splicing defect.
...
Abnormal factor VIII activity (\<40 IU/dL or 40%) via one-stage or two-stage chromogenic assay in a cell line and/or mouse model.
...
Document: ClinGen Coagulation Factor Deficiency Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for F9 Version 2.1
CSpec ID: GN080
VCEP: Coagulation Factor Deficiency Variant Curation Expert Panel
Version: 2.1
Status: current_released
Diseases: MONDO:0010604
Modes of inheritance: 
Fetched: 2026-08-05T00:33:08.999352+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN080
...
Splicing prediction score of less than or equal to 0.1 is required. Conservation should be assess using PhyloP (cutoff less than 0.1) and PhastCons (cutoff less than 0.5).
...
This evidence code can be used when a _F9_ variant is observed in a male with a normal factor IX activity level (at least >40% IU or as defined by laboratory cut off).
...
This code can be used for _F9_ gene variants studied in a cell line or mouse model setting that confer a normal factor IX activity AND normal factor IX antigen levels **OR** normal Western Blot.
...
This evidence code can be used when a _F9_ variant is observed in a male with a family history of hemophilia B and has a normal factor IX activity level.
...
This code can be used for variants affecting any of the 3 catalytic residues (H267, D315 or S411) and 2 activation residues (R191-A192 and R226-V227) in the _F9_ gene (PMID: 12554099).
...
This evidence code can be applied when there is 1 pathogenic variant or 2 likely pathogenic variants at the same residue based on _F9_ rule specification from the Coagulation Factor Deficiency VCEP and where _in silico_ predictors do not suggest a splicing defect.
...
This evidence code can be applied when there is 1 likely pathogenic variants at the same residue based on _F9_ gene rule specifications from the Coagulation Factor Deficiency VCEP and where _in silico_ predictors do not suggest a splicing defect.
...
This evidence code can be applied when there is 1 pathogenic variant or 2 likely pathogenic variants at the same residue based on _F9_ gene rule specifications from the Coagulation Factor Deficiency VCEP and where _in silico_ predictors do not suggest a splicing defect.
...
Document: ClinGen FBN1 Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines Version 1.0
CSpec ID: GN022
VCEP: FBN1 Variant Curation Expert Panel
Version: 1.0
Status: current_released
Diseases: MONDO:0007947
Modes of inheritance: 
Fetched: 2026-08-05T00:32:20.854735+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN022
...
Allele frequency above 0.1% in ExAc and gnomAD
...
* Recommended prediction program for missense variants: REVEL. Use 0.326 as a discriminatory cut-off value.
...
Allele frequency greater than expected for disease (>0.005%).
* Use the ethnic population with the highest allele frequency.
* Caveat: Do not use Finnish, Ashkenazi Jewish, or “Other” populations in gnomAD.
* Minimum amount of studied alleles should be 2000.
...
Use the ‘Funtional Assay SVI Documentation’ (https://clinicalgenome.org/working-groups/sequence-variant-interpretation/).
...
* Caution is warranted when the phenotype is not highly specific. Lack of segregation should then be clear in >1 affected family member.
...
* Add caveat: cannot be applied simultaneously with PVS1 (at any strength level)
...
* Add caveat: Use argument with caution when the original missense variant created a cysteine especially in a cbEGFlike domain (cfr PM1_strong) as this may increase the
...
Add caveat: if this argument is used pro-pathogenicity, there must be other arguments supporting pathogenicity, and no arguments supporting a benign assertion.
...
* Recommended prediction program for missense variants: REVEL. Use 0.75 as a discriminatory cut-off value.
* Recommended prediction programs for splice variants: GeneSplicer, MaxEntscan, and NNSPLICE. The outcome of all 3 prediction programs need to be in concordance.
...
* Use if patient fulfils revised Ghent criteria.
...
* Beware of changes that impact splicing rather than the amino acid. Splicing predictions should remain the same for WT and mutant alleles.
...
Follow the ‘Funtional Assay SVI Documentation’
...
Use the ‘Funtional Assay SVI Documentation’.
...
* Initiation codon variant with 1 or more pathogenic variant(s) upstream of closest potential in-frame start codon.
...
* Nonsense/frameshift variants predicted to escape NMD (affecting last exon, last 55nt of the penultimate exon).
...
* Nonsense/frameshift variants predicted to undergo NMD (not affecting last exon or 55 last nt of penultimate exon).
...
Document: ClinGen Severe Combined Immunodeficiency Disease  Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for FOXN1 Version 2.3
CSpec ID: GN113
VCEP: Severe Combined Immunodeficiency Disease  Variant Curation Expert Panel
Version: 2.3
Status: current_released
Diseases: MONDO:0011132
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0032113
Fetched: 2026-08-05T00:33:38.050059+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN113
...
Applicable only when observed in cis with a pathogenic variant in any inheritance pattern, with the additional requirement that the co-occurring variant must be classified using the SCID VCEP specifications for _FOXN1._
...
•Supporting evidence can be applied for a REVEL score of \<0.290 based on recommendations of Pejaver et al., 2022 (PMID: 36413997).

•Also applicable to synonymous or intronic variants not predicted to impact splicing by SpliceAI ∆ score ≤0.1
...
Applicable for variants in the DNA binding forkhead domain (amino acids 270-367), which is a well-established functional domain (Newman et al., 2020; PMID: 31914405) of _FOXN1_ with low tolerance for benign variation.
...
*   Supporting evidence can be applied for a REVEL score of ≥0.644 (to \<0.932), based on recommendations of Pejaver et al., 2022 (PMID: 36413997).
*   Also applicable to missense, synonymous, or intronic variants predicted to impact splicing by SpliceAI ∆ score ≥0.2
...
Applicable for a same amino acid change if previously established variant is classified as likely pathogenic by SCID VCEP specifications for _FOXN1._

Can also be applied for variants with the same predicted splicing event as a known (Likely) Pathogenic variant (as classified by the SCID VCEP specifications for _FOXN1_), only when the strength of the prediction for the variant under assessment is of similar or higher strength than the strength of the prediction for the comparison (Likely) Pathogenic variant (i.e., per in silico splicing tool SpliceAI). See attached instructions (from Table 2 of PMID: [37352859](https://pubmed.ncbi.nlm.nih.gov/37352859)) for determining when PS1 should be applied at PS1\_Strong, \_Moderate, or \_Supporting.
...
Applicable for a same amino acid change if previously established variant is classified as pathogenic by SCID VCEP specifications for _FOXN1._

Can also be applied for variants with the same predicted splicing event as a known Pathogenic variant (as classified by the SCID VCEP specifications for _FOXN1_), only when the strength of the prediction for the variant under assessment is of similar or higher strength than the strength of the prediction for the comparison (Likely) Pathogenic variant (i.e., per in silico splicing tool SpliceAI). See attached instructions (from Table 2 of PMID: [37352859](https://pubmed.ncbi.nlm.nih.gov/37352859)) for determining when PS1 should be applied at PS1\_Strong, \_Moderate, or \_Supporting.
...
*   For variants not predicted to undergo nonsense-mediated decay, but removing >10% of protein, (i.e. variants in the last exon, exon 9, or variants in the last 50 nucleotides of the penultimate exon after c.1577, codon 526, in exon 8), when at least one pathogenic variant is not present downstream downgrade to PVS1\_Moderate
...
*   For variants not predicted to undergo nonsense-mediated decay, but removing >10% of protein, (i.e. variants in the last exon, exon 9, or variants in the last 50 nucleotides of the penultimate exon after c.1577, codon 526, in exon 8), at least one pathogenic variant must be present downstream in order to apply PVS1\_Strong
*   PVS1\_Strong can be applied to variants not predicted to undergo nonsense-mediated decay but removing/altering the transactivation domain (amino acids 511-563; Schlake et al., 2000 PMID: 10767081).
...
*   PVS1 can be applied to variants not predicted to undergo nonsense-mediated decay but removing/altering the critical forkhead domain (amino acids 270-367; Newman et al., 2020; PMID: 31914405) based on recommendations from Walker et. al., 2023 (PMID: 37352859).

# GAA

Document: ClinGen Lysosomal Storage Disorders Variant Curation Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines Version 2.0
CSpec ID: GN010
VCEP: Lysosomal Diseases Variant Curation Expert Panel
Version: 2.0
Status: current_released
Diseases: MONDO:0009290
Modes of inheritance: 
Fetched: 2026-08-05T00:32:10.125542+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN010
...
Detected in trans with a pathogenic variant. Points-based system. See main specifications document.
...
PP3 upgraded in strength to Moderate
...
Null variant in a gene where loss of function is a known mechanism of disease or in frame loss of an exon that contains residues involved in the active site of GAA.
...
Document: ClinGen Galactosemia Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for GALT Version 1.1
CSpec ID: GN158
VCEP: Galactosemia Variant Curation Expert Panel
Version: 1.1
Status: current_released
Diseases: MONDO:0018116
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0000007
Fetched: 2026-08-05T00:34:16.323590+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN158
...
Use a minor allele frequency cutoff of ≥0.01 (1%) (use PopMax  FAF in gnomAD). This frequency was calculated using the Whiffen-Ware calculator with a prevalence estimated at 1 in 10,000, penetrance at 100%, maximum allelic contribution and maximum genetic contribution at 100%.
...
*   Observed in cis with a likely pathogenic or pathogenic variant OR observed in trans with a pathogenic variant in an unaffected individual with RBC GALT enzyme activity in the carrier range
*   Pathogenicity of first variant must be determined using VCEP guidelines. 
*   Full gene sequencing including promoter region must have been completed to apply BP2
...
*   For missense variants use REVEL with a score of \<0.15 
*   In-frame in/dels, Provean (“neutral”) and MutationTaster (“polymorphism”) must agree

For non-canonical splicing variants use SpliceAI with a score of \<0.1, do not use if there is evidence of a cryptic splice site
...
*   Use “as is”, but no conservation requirement 
...
Use a minor allele frequency cutoff of ≥0.005 (0.5%) (use PopMax  FAF in gnomAD). This frequency was calculated using the Whiffen-Ware calculator with a prevalence estimated at 1 in 10,000, penetrance at 100%, maximum allelic contribution of 50% and maximum genetic contribution at 100%.
...
This code is applicable when individual is confirmed to be unaffected by GALT activity levels
...
*   Functional assay in non-patient material 
*   BS3\_Supporting is applicable for greater than 50% enzyme activity in a model system (cannot apply at strong level)
...
Individual considered unaffected RBC GALT enzyme activity ≥25% with the caveat of no bone marrow transfusions in individual.
...
PM1 applied at moderate strength for variants that occur in the active site from Phe171 to Gln188
...
*   Use if variant is present at ≤ 0.0005 or 0.05% 
    *   One order of magnitude below BS1
*   PM2 is not considered conflicting data with BP4 or BP7
*   A curated list of _GALT_ variants known to be pathogenic despite not fulfilling the PM2 criterion has been developed (see PM2 exception list)
...
Variant under investigation meets PM2, identified individual(s) meet PP4, and at least 1 PM3 point has been reached.
...
Variant under investigation meets PM2, identified individuals meet PP4, and at least 2 PM3 points have been reached.
...
Variant under investigation meets PM2, identified individual(s) meet PP4, and at least 0.5 PM3 points have been reached.
...
Variant under investigation meets PM2, identified individuals meet PP4, and at least 4 PM3 points have been reached.
...
*   The other variant(s) used for evidence should also have been curated using the GALT VCEP rule specifications and must reach a pathogenic/likely pathogenic classification without PM5.
...
Paternity and maternity must be confirmed. Patient must meet PP4.

Because there has only ever been one reported de novo occurrence of a _GALT_ variant and de novo occurrence is not expected to significantly contribute to disease, the VCEP will use PM6 and not PS2. PM6 will not be upgraded with number of occurrences.
...
Using general recommendations from Oza AM et al., 2018, PMID: 30311386, sufficient affected and unaffected segregations have been counted to reach likelihood of 16:1.
...
Use general recommendations from Oza AM et al, 2018, PMID: 30311386, sufficient affected and unaffected segregations have been counted to reach likelihood of 32:1.
...
Using general recommendations from Oza AM et al., 2018, (PMID: 30311386), sufficient affected and unaffected segregations have been counted to reach likelihood of 4:1.
...
*   For missense variants use REVEL with a score ≥0.7 
*   In-frame in/dels, Provean (“deleterious”) and MutationTaster (“Disease-causing”) must agree
*   For non-canonical splicing variants use SpliceAI with a score ≥0.2, look for cryptic splice sites.
...
*   RBC GALT enzyme activity \<10%
*   In order to apply PP4 at the moderate level, newborn screen alone would not count, must have confirmatory testing. 
*   For PP4 to be applied at moderate level, full _GALT_ gene sequencing (exons and exon/intron boundaries) rather than _GALT_ panel testing must have been carried out.
*   Variants must meet PM2\_Supporting for PP4 to apply at any strength.
...
*   RBC GALT enzyme activity \<10%
*   In order to apply PP4 at the supporting level, newborn screen alone would not count, must have confirmatory testing.
...
*   Same predicted impact on splicing as previously classified variant (refer to table 2 in Walker et al., 2023, PMID: 37352859).
    *   PS1 can by applied at varying strengths (strong, moderate, supporting) in conjunction with either PP3 or PVS1. PS1 strength depends on location of the variant under assessment (within or outside the +/- 1,2 dinucleotide positions) and the location of the previously classified variant (within or outside the +/-1,2, dinculeotide position). Specific combinations are outlined in table 2 Walker et al., 2023, PMID: 37352859.
*   PS1\_Moderate will apply for 1 previously established likely pathogenic variant or use Table 2 in Walker et al., 2023, PMID: 37352859 for splicing variant
...
*   Splicing abnormalities (using VCEP-specified prediction algorithms or evidence from literature) should be excluded for all missense variants
*   PS1 will be applied at the strong level for 1 previously established pathogenic missense variant or use Table 2 in Walker et al., PMID: 37352859 for splicing variant
*   The other variant(s) used for evidence should also have been curated using GALT VCEP rule specifications and reach a pathogenic/likely pathogenic classification without using PS1.
*   Same predicted impact on splicing as previously classified variant (refer to table 2 in Walker et al., 2023, PMID: 37352859).
    *   PS1 can by applied at varying strengths (strong, moderate, supporting) in conjunction with either PP3 or PVS1. PS1 strength depends on location of the variant under assessment (within or outside the +/- 1,2 dinucleotide positions) and the location of the previously classified variant (within or outside the +/-1,2, dinculeotide position). Specific combinations are outlined in table 2 Walker et al., 2023, PMID: 37352859.
...
*   Same predicted impact on splicing as previously classified variant (refer to table 2 in Walker et al., 2023, PMID: 37352859).
    *   PS1 can by applied at varying strengths (strong, moderate, supporting) in conjunction with either PP3 or PVS1. PS1 strength depends on location of the variant under assessment (within or outside the +/- 1,2 dinucleotide positions) and the location of the previously classified variant (within or outside the +/-1,2, dinculeotide position). Specific combinations are outlined in table 2 Walker et al., 2023, PMID: 37352859.
*   PS1\_Supporting will apply for splicing variants only, used Table 2 in Walker et al., 2023, PMID: 37352859
...
Applicable for up to 20% enzyme activity in a model system
...
Refer to PVS1 decision tree attached.
...
*   The Galactosemia VCEP will utilize SVI’s PVS1 recommendation for determining applicable PVS1 strength level (Abou Tayoun et al 2018; PMID: 30192042). Refer to the modified PVS1 decision tree attached.
*   Exons 6, 7, and 9 are in-frame. Exon skipping consequences for splice site variants are listed in the attachment as well.

# GAMT

Document: ClinGen Cerebral Creatine Deficiency Syndromes Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for GAMT Version 2.0
CSpec ID: GN026
VCEP: Cerebral Creatine Deficiency Syndromes Variant Curation Expert Panel
Version: 2.0
Status: current_released
Diseases: MONDO:0012999
Modes of inheritance: 
Fetched: 2026-08-05T00:32:24.381905+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN026
...
*   Allele frequency >0.003 (0.3%) in gnomAD v4.0 in any continental population with >2000 alleles (based on the estimated prevalence 1 in 114,000, PMID 24071436) in gnomAD v4.0 (max allelic contribution = 100%; max genetic contribution = 100%).
...
*   REVEL score \<0.29 for missense variants (based on guidance from Pejaver et al, 2022, PMID: 36413997).
...
A synonymous (silent) variant OR an intronic variant at or beyond positions +7 and -21, for which SpliceAI, [https://spliceailookup.broadinstitute.org/](https://spliceailookup.broadinstitute.org/), predicts no impact on splicing (score \<0.1).
...
*   Allele frequency >0.001 (0.1%) in gnomAD v4.0 in any continental population with >2000 alleles (based on the estimated prevalence 1 in 114,000 (PMID: 24071436) in gnomAD v4.0 (max allelic contribution = 40%; max genetic contribution = 100%).
*   Use the highest population minor allele frequency (MAF) in any given continental population with >2,000 alleles (European non-Finnish, African, East Asian, South Asian, Latino) (PMID 30311383).
...
**Allele frequency \<0.0004 (\<0.04%) in all populations in gnomAD.**
...
*   Follow SVI guidance for PM3 ([https://clinicalgenome.org/site/assets/files/3717/svi_proposal_for_pm3_criterion_-_version_1.pdf](https://clinicalgenome.org/site/assets/files/3717/svi_proposal_for_pm3_criterion_-_version_1.pdf)).
...
GAMT specifications: Use this rule “as is” for stop loss variant, and in frame deletions and insertions of 2 or more amino acids, but downgrade to PM4\_Supporting for single amino acid deletions and insertions.
...
Downgrade to PM4\_Supporting for single amino acid deletions and insertions.
...
*   This criterion is applicable for any variant resulting in a different amino acid change, at the same amino acid position, as a variant that has been previously established as pathogenic by the CCDS VCEP, by assessment using these criteria, regardless of nucleotide change.
...
*   This criterion is applicable for any variant resulting in a different amino acid change, at the same amino acid position, as a variant that has been previously established as likely pathogenic by the CCDS VCEP, by assessment using these criteria, regardless of nucleotide change.
*   If the variant is in the last 3 nucleotides of an exon, further analysis using splicing site prediction algorithms (see PP3) and data from the literature (if available) is required to investigate the impact on splicing.  
...
*   Missense variant with a REVEL score 0.644-0.773 (based on guidance from Pejaver et al, 2022, PMID: 36413997).
...
3 points based on any combination of the following. Two or more data types are recommended to apply PP4\_Moderate:
...
4 points based on any combination of the following. Two or more data types are required to apply PP4\_Strong:
...
*   This criterion is applicable for any variant resulting in the same amino acid change as a variant that has been previously established as likely pathogenic by the CCDS VCEP, by assessment using these criteria, regardless of nucleotide change.
*   If the variant is in the last 3 nucleotides of an exon, further analysis using splicing site prediction algorithms (see PP3) and data from the literature (if available) is required to investigate the impact on splicing.
...
*   This criterion is applicable for any variant resulting in the same amino acid change as a variant that has been previously established as pathogenic by the CCDS VCEP, by assessment using these criteria, regardless of nucleotide change.
*   If the variant is in the last 3 nucleotides of an exon, further analysis using splicing site prediction algorithms (see PP3) and data from the literature (if available) is required to investigate the impact on splicing.
...
PS1\_Supporting may be applied for splicing variants under specific circumstances (see Table 3 in PMID: 37352859).
...
PS3\_Supporting can be assigned if a variant is expressed in GAMT-deficient fibroblasts, HeLa cells and has \<15% of the control value, for values published in Mercimek-Mahmutoglu et al, 2014, PMID 24415674; Mercimek-Mahmutoglu et al, 2016, PMID 26319512; or DesRoches et al, 2016, PMID 26003046.
...
Document: ClinGen Cerebral Creatine Deficiency Syndromes Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for GATM Version 2.0
CSpec ID: GN025
VCEP: Cerebral Creatine Deficiency Syndromes Variant Curation Expert Panel
Version: 2.0
Status: current_released
Diseases: MONDO:0012996
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0000007
Fetched: 2026-08-05T00:32:23.459357+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN025
...
Observed in cis with a pathogenic variant (to take AR inheritance for AGAT deficiency into account).
...
A synonymous (silent) variant OR an intronic variant at or beyond positions +7 and -21, for which SpliceAI, [https://spliceailookup.broadinstitute.org/](https://spliceailookup.broadinstitute.org/), predicts no impact on splicing (score \<0.1) (see Walker et al, 2023, PMID: 37352859).
...
**Allele frequency \<0.000055 (\<0.0055%) in all populations in gnomAD.**
...
Downgrade to PM4\_Supporting for in frame deletion/insertion of a single amino acid.
...
If the pathogenicity of another missense change at the same amino acid residue is unknown, determine its pathogenicity using these specifications in order to determine if this criterion can be used. If the variant is pathogenic, use PM5. If the variant is likely pathogenic, use PM5\_Supporting.
...
Missense variant with a REVEL score >0.773 (based on guidance from Pejaver et al, 2022, PMID: 36413997).
...
3 points based on any combination of the following. Two or more data types are recommended to reach moderate:  
...
4 or more points based on any combination of the following. Two or more data types are required to meet Strong:  
• Low urine guanidinoacetate with or without low or low normal creatine (1 point)  
• Low plasma guanidinoacetate with or without low or low normal creatine (2 points)  
• Significantly decreased creatine peak in brain magnetic resonance spectroscopy (3 points)  
• AGAT enzyme activity \<5% of normal (3 points)
...
*   This criterion is applicable as is for any variant resulting in the same amino acid change as a previously established pathogenic variant regardless of nucleotide change.
*   If the variant is in the last 3 nucleotides of an exon, further analysis using splicing site prediction algorithms (see PP3) and data from the literature (if available) is required to investigate the impact on splicing.
*   PS1 may also be applied for splicing variants under specific circumstances (see Table 3 in PMID: 37352859).
...
AGAT activity data from an in vitro assay in which GATM variants were overexpressed in HeLa cells has been published (DesRoches et al, 2016; PMID 27233232). Any variant with AGAT activity at or below 15% of normal in this paper meets PS3\_Supporting (see Appendix 3 for further details on AGAT functional assays).
...
**Single exon or larger deletion resulting in loss of \<10% of the protein, and initiator codon variants.**
...
**In frame loss of >10% of the protein.**  
CCDS VCEP notes:  
...
Document: ClinGen Monogenic Diabetes Expert Panel Specifications to the ACMG/AMP Variant Interpretation Guidelines for GCK Version 3.1
CSpec ID: GN086
VCEP: Monogenic Diabetes Variant Curation Expert Panel
Version: 3.1
Status: current_released
Diseases: MONDO:0015967
Modes of inheritance: https://hpo.jax.org/app/browse/term/HP:0032113
Fetched: 2026-08-05T00:33:14.219732+00:00
Source API: https://cspec.genome.network/cspec/api/SequenceVariantInterpretation/id/GN086
...
Use a REVEL score of ≤0.15 as supportive evidence of no predicted impact on the gene or gene product. We also support using SpliceAI to assess the predicted impact of non-canonical splicing variants and synonymous variants: apply BP4 when the predicted change is below 0.2[<sup>9</sup>](#pmid_32123317),[<sup>10</sup>](#pmid_30661751).
...
Use GCK PS3 decision tree, which incorporates the relative activity index (RAI), relative stability index (RSI) and assays that measure the impact of variants on binding with GKRP and GKA.
...
Gloyn, et al. 2005 [<sup>5</sup>](#pmid_15677479); Beer, et al. 2012 [<sup>6</sup>](#pmid_22611063); Raimondo, et al. 2014 [<sup>7</sup>](#pmid_25015100); Gloyn, et al. (2004)<sup>12</sup>.
...
Applicable for glucose- and ATP-binding sites (see attached chart for details).
...
Apply at the Supporting level when there is an insertion or deletion of a single amino acid in a non-repeat region.
...
Use thresholds suggested by Jarvik and Browning[<sup>8</sup>](#pmid_27236918)
...
Apply to all missense variants in GCK. gnomAD missense constraint score for _GCK_ is 3.07 (observed/expected= 0.5), which is significant.
...
Use REVEL score of ≥0.70 as supportive evidence of pathogenicity. We also support using SpliceAI to assess the predicted impact of non-canonical splicing variants and synonymous variants: apply PP3 when the predicted change is at least 0.2[<sup>9</sup>](#pmid_32123317),[<sup>10</sup>](#pmid_30661751)
...
HbA1C 5.6 – 7.6% (38-60 mmol/mol) (if given multiple results, use maximum value) AND fasting plasma glucose always (FPG) 5.5-8 mmol/L (100-144 mg/dL) AND presence of any of the following additional features:
...
HbA1C 5.6 – 7.6% (38-60 mmol/mol) (if given multiple results, use maximum value) AND fasting plasma glucose always (FPG) 5.5-8 mmol/L (100-144 mg/dL)
...
Applicable for a same amino acid change if the previously established variant is classified as likely pathogenic by ClinGen MDEP specifications.
...
Applicable for a same amino acid change if the previously established variant is classified as pathogenic by ClinGen MDEP specifications.
...
*   “Exon skipping or  “use of a cryptic splice site that preserves reading frame” and “Single to multi-exon deletion that preserves reading frame” 
    *   single exon deletions 
        ...
        *   deletions or skipping of **exons 4 and 5** are in-frame and the proportion is \<10 % (40 AA and 32 AA, respectively). Exon 4 (p.122-161) and exon 5 (p.162-193) contain each a part of the active site that binds glucose /p.151-180[<sup>3</sup>](#pmid_23957911) according to Beck et al., Biochemistry 2013/ --> **PVS1** 
